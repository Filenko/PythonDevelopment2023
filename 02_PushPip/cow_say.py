...
def parseArgs(parser):
    ...
    preset = ''.join([mode for mode in "bdgpstwy" if mode in args.__dict__])
    return args, preset
...
def main():
    ...
    if args.l:
        ...
        print(cowsay(args.message, preset=preset, eyes=args.e, tongue=args.T,
                     width=args.W, wrap_text=args.n, cowfile=args.f))
